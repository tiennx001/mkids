...
<?php include_partial('sfGuardGroup/header') ?>
...
<div class="container-fluid">
    <div class="row-fluid">
      ...
      <?php include_partial('sfGuardGroup/list_sidebar', array('configuration' => $configuration)) ?>
      <?php endif; ?>

        <div class="span<?php echo $sidebar_status ? '10' : '12'; ?>">

            <div class="span12">
                <h1 style="display: inline"><?php echo __('Quản lý nhóm người dùng', array(), 'messages') ?></h1>
            </div>
            <div class="row-fluid">
                <div class="span9">
          ...
          <?php include_partial('sfGuardGroup/flashes') ?>
            ...
            <div id="sf_admin_content">
                <form class="form-inline" id="list-form"
                      action="<?php echo url_for('sf_guard_group_collection', array('action' => 'batch')) ?>"
                      method="post">
                ...
                <div  style="float:left ">
                    <div class="pull-right"><?php include_partial('sfGuardGroup/list_actions', array('helper' => $helper)) ?></div>
                </div>
                <form class="form-inline" method="get" action="<?php echo url_for('sf_guard_group') ?>">
                    <div class="well pull-right">
                      ...
                      array('class' => 'input-medium')); echo $select->render('max_per_page', $sf_user->getAttribute('sfGuardGroup.max_per_page', null, 'admin_module')) ?>
...
<?php include_partial('sfGuardGroup/footer') ?>