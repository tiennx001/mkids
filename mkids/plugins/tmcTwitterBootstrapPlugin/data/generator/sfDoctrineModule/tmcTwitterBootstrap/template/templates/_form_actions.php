<div class="btn-toolbar">
    <?php foreach (array('new', 'edit') as $action): ?>
        ...
        <?php if (array_key_exists('_save', $actions) || array_key_exists('_save_and_add', $actions) || array_key_exists('_save_and_exit', $actions)): ?>
            <div class="btn-group">
                ...
                <?php endif ?>
                <?php if (array_key_exists('_save_and_exit', $actions)): ?>
                  <?php echo $this->addCredentialCondition('[?php echo $helper->linkToSaveAndExit($form->getObject(), '.$this->asPhp($actions['_save_and_exit']).') ?]', $actions['_save_and_exit']) ?>
                  <?php unset($actions['_save_and_exit']) ?>
                <?php endif; ?>
