...
class tmcTwitterBootstrapDoctrineGenerator extends sfDoctrineGenerator
{
    ...
    public function renderField($field)
    {
        ...
        $truncateLength = (isset($fieldConfig['truncate_length']))? $fieldConfig['truncate_length']: sfConfig::get('app_truncate_length', 50);
        $html = sprintf(" VtHelper::truncate(%s, %s, '...', true) ", $html, $truncateLength);
