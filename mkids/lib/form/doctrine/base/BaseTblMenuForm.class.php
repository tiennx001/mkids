...
/**
 * TblMenu form base class.
 *
 * @method TblMenu getObject() Returns the current form's model object
 *
 * @package    xcode
 * @subpackage form
 ...
 */
abstract class BaseTblMenuForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'description'     => new sfValidatorString(array('max_length' => 1023)),
    ...
    $this->widgetSchema->setNameFormat('tbl_menu[%s]');
