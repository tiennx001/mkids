...
/**
 * TblNotificationProgram form base class.
 *
 * @method TblNotificationProgram getObject() Returns the current form's model object
 *
 * @package    xcode
 * @subpackage form
 ...
 */
abstract class BaseTblNotificationProgramForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbl_notification_program[%s]');
