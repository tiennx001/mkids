...
/**
 * TblGroup filter form base class.
 *
 * @package    xcode
 * @subpackage filter
 ...
 */
abstract class BaseTblGroupFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbl_group_filters[%s]');
