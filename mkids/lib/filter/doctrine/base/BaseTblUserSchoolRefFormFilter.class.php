...
/**
 * TblUserSchoolRef filter form base class.
 *
 * @package    xcode
 * @subpackage filter
 ...
 */
abstract class BaseTblUserSchoolRefFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbl_user_school_ref_filters[%s]');
