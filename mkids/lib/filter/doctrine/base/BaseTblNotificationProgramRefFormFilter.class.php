...
/**
 * TblNotificationProgramRef filter form base class.
 *
 * @package    xcode
 * @subpackage filter
 ...
 */
abstract class BaseTblNotificationProgramRefFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbl_notification_program_ref_filters[%s]');
