...
/**
 * TblNotificationHis filter form base class.
 *
 * @package    xcode
 * @subpackage filter
 ...
 */
abstract class BaseTblNotificationHisFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbl_notification_his_filters[%s]');
