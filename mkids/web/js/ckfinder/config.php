...
$configuration = ProjectConfiguration::getApplicationConfiguration('subAdmin', 'prod', true);
$context = sfContext::createInstance($configuration);
//$context = dm::createContext($configuration);
...
if(sfContext::getInstance()->getUser()->isAuthenticated()){
  ...
  $y = sfContext::getInstance()->getUser()->getGuardUser()->getUsername();
  $dirCk = sfConfig::get('sf_web_dir').'/'.VtHelper::generatePath();
  $schoolId = sfContext::getInstance()->getUser()->getGuardUser()->getschoolId();
  if(sfContext::getInstance()->getUser()->isSuperAdmin() && isset($schoolId))
  {
    $baseUrl = sfConfig::get('app_path_ckeditor').VtHelper::getSecretPath().'/';
  }
  // else
  // {
    // $baseUrl = sfConfig::get('app_path_ckeditor');
  // }
}
